...
@validator_args
def default_create_package_request_schema(
        duplicate_extras_key, ignore, empty_if_not_sysadmin, ignore_missing,
        unicode_safe, package_id_does_not_exist, email_validator,not_empty,
        boolean_validator, datasets_with_no_organization_cannot_be_private, isodate):
    return {
        '__before': [duplicate_extras_key, ignore],
        'id': [empty_if_not_sysadmin, ignore_missing, unicode_safe,
               package_id_does_not_exist],
        'notes': [ignore_missing, unicode_safe,not_empty],
        'email': [ignore_missing, unicode_safe, email_validator,not_empty],
        'owner_org': [ignore_missing, unicode_safe,not_empty],        
        'first_name': [ignore_missing, unicode_safe,not_empty],
        'package_name': [ignore_missing, unicode_safe,not_empty],
        'scope': [ignore_missing, unicode_safe,not_empty],
        'send_data': [ignore_missing, boolean_validator,
                    datasets_with_no_organization_cannot_be_private],
        'objective': [ignore_missing, unicode_safe,not_empty],
        'last_name': [ignore_missing, unicode_safe,not_empty],
        'modified': [ignore_missing, isodate],
        'created': [ignore_missing, isodate]       
    }

@validator_args
def default_group_repair_schema(
        duplicate_extras_key, ignore, empty_if_not_sysadmin, ignore_missing,
        unicode_safe, package_id_does_not_exist, email_validator,not_empty,
        boolean_validator, datasets_with_no_organization_cannot_be_private, isodate):
    return {
        ...
        'description': [ignore_missing, unicode_safe,not_empty],
        'state': [ignore_missing, unicode_safe,not_empty],
        'type': [ignore_missing, unicode_safe,not_empty],
        'is_organization': [ignore_missing, boolean_validator,
                    datasets_with_no_organization_cannot_be_private],
        'approval_status': [ignore_missing, unicode_safe,not_empty],
        'image_url': [ignore_missing, unicode_safe,not_empty],
        'created': [ignore_missing, isodate]       
    }


@validator_args
def default_show_package_request_schema():
    schema = default_create_package_request_schema()
...
def default_user_schema(
    ...
    return {
        ...
        'phone': [ignore_missing, unicode_safe],
        'address': [ignore_missing, unicode_safe],
        'secret_level': [ignore_missing, unicode_safe],
    }
